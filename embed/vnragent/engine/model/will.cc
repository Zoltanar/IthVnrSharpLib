...
class TextHookW
{
  ...
  bool hookBefore(winhook::hook_stack *s)
  {
    ...
    if (!trimmedSize || !*trimmedText)
      return true;
    QString oldText = QString::fromUtf16(trimmedText, trimmedSize),
    ...
    if (prefixSize)
      newText.prepend(QString::fromUtf16(text, prefixSize));
    if (suffixSize)
      newText.append(QString::fromUtf16(trimmedText + trimmedSize, suffixSize));
    text_ = newText;
