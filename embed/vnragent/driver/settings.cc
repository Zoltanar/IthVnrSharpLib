...
void Settings::load(const QString& json)
{
	...
	for (auto it = map.constBegin(); it != map.constEnd(); ++it) {
		...
		auto key = it.key();
		if (key == "windowTranslationEnabled") setWindowTranslationEnabled(bValue);
		else if (key == "windowTranscodingEnabled") setWindowTranscodingEnabled(bValue);
		else if (key == "windowTextVisibleChange") setWindowTextVisible(bValue);
		else if (key == "embeddedScenarioVisible") setEmbeddedScenarioVisible(bValue);
		else if (key == "embeddedScenarioTextVisible") setEmbeddedScenarioTextVisible(bValue);
		else if (key == "embeddedScenarioTranslationEnabled") setEmbeddedScenarioTranslationEnabled(bValue);
		else if (key == "embeddedScenarioTranscodingEnabled") setEmbeddedScenarioTranscodingEnabled(bValue);
		else if (key == "embeddedNameVisible") setEmbeddedNameVisible(bValue);
		else if (key == "embeddedNameTextVisible") setEmbeddedNameTextVisible(bValue);
		else if (key == "embeddedNameTranslationEnabled") setEmbeddedNameTranslationEnabled(bValue);
		else if (key == "embeddedNameTranscodingEnabled") setEmbeddedNameTranscodingEnabled(bValue);
		else if (key == "embeddedOtherVisible") setEmbeddedOtherVisible(bValue);
		else if (key == "embeddedOtherTextVisible") setEmbeddedOtherTextVisible(bValue);
		else if (key == "embeddedOtherTranslationEnabled") setEmbeddedOtherTranslationEnabled(bValue);
		else if (key == "embeddedOtherTranscodingEnabled") setEmbeddedOtherTranscodingEnabled(bValue);

		else if (key == "embeddedSpaceAlwaysInserted") setEmbeddedSpaceAlwaysInserted(bValue);
		else if (key == "embeddedSpaceSmartInserted") setEmbeddedSpaceSmartInserted(bValue);
		else if (key == "embeddedSpacePolicyEncoding") setEmbeddedSpacePolicyEncoding(value);

		else if (key == "embeddedTextEnabled") setEmbeddedTextEnabled(bValue);
		//else if(key == "embeddedTextCancellableByControl") setEmbeddedTextCancellableByControl(bValue);
		else if (key == "embeddedAllTextsExtracted") setEmbeddedAllTextsExtracted(bValue);

		else if (key == "embeddedScenarioWidth") setEmbeddedScenarioWidth(value.toInt());
		else if (key == "embeddedTranslationWaitTime") setEmbeddedTranslationWaitTime(value.toInt());

		else if (key == "scenarioSignature") setScenarioSignature(value.toLong());
		else if (key == "nameSignature") setNameSignature(value.toLong());

		else if (key == "embeddedFontFamily") setEmbeddedFontFamily(value);
		else if (key == "embeddedFontCharSet") setEmbeddedFontCharSet(value.toInt());
		else if (key == "embeddedFontCharSetEnabled") setEmbeddedFontCharSetEnabled(bValue);
		else if (key == "embeddedFontWeight") setEmbeddedFontWeight(value.toInt());
		else if (key == "embeddedFontScale") setEmbeddedFontScale(value.toLong());
		else if (key == "gameEncoding") setGameEncoding(value);
		else if (key == "debug")
		{
			if (bValue) Util::installDebugMsgHandler();
			else Util::uninstallDebugMsgHandler();
		}
