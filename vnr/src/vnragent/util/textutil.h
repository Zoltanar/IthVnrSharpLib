...
{ return allHangul(static_cast<const wchar_t *>((const wchar_t*)text.utf16())); }
...
{ return allAscii(static_cast<const wchar_t *>((const wchar_t*)text.utf16())); }
...
{ return measureTextSize(static_cast<const wchar_t *>((const wchar_t*)text.utf16())); }
